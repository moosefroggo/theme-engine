...
export function BioSection() {
  ...
  const { bio, skills, links } = MOCK_AUTHOR;
  ...
  const container = {
    ...
    visible: {
      opacity: 1,
      transition: { staggerChildren: 0.08, delayChildren: 0.1, ...transition },
    },
  };
  ...
  return (
    <>
      ...
      >
        <motion.h2 variants={item} className="text-2xl font-bold font-display mb-6">
          About
        </motion.h2>
